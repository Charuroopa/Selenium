...
public interface WdMethods {
		...
		/**
		 * This method will locate the list of element using any given locator
		 * @param locator  - The locator by which the element to be found
		 * @param locValue - The locator value by which the element to be found
		 * @author Babu - TestLeaf
		 * @throws NoSuchElementException
		...
		/**
		 * This method will enter the value in the given text field and attribute that is giving tabs/seconds
		 * @param ele   - The Webelement (text field) in which the data to be entered
		 * @param data  - The data to be sent to the webelement
		 * @author Babu - TestLeaf
		 * @throws ElementNotVisibleException		 * 
		...
		/**
		 * This method will clear the element 
		 * @param ele   - The Webelement (button/link/element) to be clicked
		 * @author Babu - TestLeaf
		 */
		...
		//public void findRowColumn(WebElement ele);
		...
		/**
		 * This method will go to alert opened
		 * @author Babu - TestLeaf
		 */
