	...
	public class CheckboxUnselect {
		...
		public static void main(String[] args) {
			...
			new WebDriverWait(driver, 50).until(ExpectedConditions.visibilityOf(chk));
			
			DeSelect_The_Checkbox(chk);
		...
		private static void DeSelect_The_Checkbox(WebElement chk) {
			// TODO Auto-generated method stub
			try {
	            if (chk.isSelected()) {
	            	...
	            	System.out.println("Checkbox: "+chk+"is already deselected");
	            }
	        } catch (Exception e) {
	        	System.out.println("Unable to deselect checkbox: "+chk);
	        }
